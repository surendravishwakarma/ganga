...
import 'package:ganga/provider_module/base/provider_response.dart';
...
class ProviderBase with ChangeNotifier {
  ...
  int get previousStatusCode => _previousResponse?.statusCode ?? 0;
  ...
  int get statusCode => _providerResponse?.statusCode ?? 0;
